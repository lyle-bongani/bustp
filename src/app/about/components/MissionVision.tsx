    ...
    return (
        <Box component="section" sx={{ width: '100%', background: '#fff', py: { xs: 6, md: 10 }, px: 2 }}>
            <Container maxWidth="lg">
                ...
                <Typography sx={{ fontFamily: 'Josefin Sans', fontSize: '1.12rem', color: '#222', mb: 6, maxWidth: 700, mx: 'auto', textAlign: 'center' }}>
                ...
                <Typography sx={{ fontFamily: 'Josefin Sans', fontSize: '1.08rem', color: '#444', mt: 6, textAlign: 'center', maxWidth: 700, mx: 'auto' }}>
